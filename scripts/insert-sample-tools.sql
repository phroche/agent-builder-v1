-- Insert sample tools into tool_cards table
...
INSERT INTO tool_cards (name, description, image, category, status, published, error) VALUES
  ...
  ('AWS S3', 'Cloud storage service for file storage and retrieval', 'https://via.placeholder.com/150/FF9900/FFFFFF?text=S3', 'Storage', 'active', true, false),
  ('SendGrid', 'Email delivery service with powerful APIs', 'https://via.placeholder.com/150/1A82E2/FFFFFF?text=SendGrid', 'Communication', 'active', false, false);
